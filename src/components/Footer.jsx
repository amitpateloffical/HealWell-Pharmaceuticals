          ...
          <div className="row g-5">
            <div className="col-md-6 col-lg-3 wow fadeIn " data-wow-delay="0.1s">
              <a href="index.html" className="d-inline-block mb-3">
                ...
                HealWell <span className="text-primary"></span>Pharmaceuticals
                </h1>
              </a>
              <p className="mb-0 style={{ fontSize: '14px' }}>">
              "HealWell Pharmaceuticals offers cutting-edge treatments, backed by rigorous research and quality assurance, ensuring optimal patient care and outcomes."
              </p>
          ...
          <div className="copyright">
            <div className="row">
              <div className="col-md-6 text-center text-md-start mb-2 mb-md-0">
                &copy; HealWell Pharmaceuticals, All Right Reserved.
              </div>
